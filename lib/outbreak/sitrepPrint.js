...
.sitrep{box-sizing:border-box;background:#fff;color:#202932;font:11pt/1.45 Arial,sans-serif;max-width:210mm;margin:0 auto;padding:15mm;overflow-wrap:anywhere}
.sitrep *{box-sizing:border-box}.sitrep h1{font-size:21pt;line-height:1.15;color:#bb202b;margin:6pt 0}
.sitrep h2{font-size:14pt;color:#bb202b;border-bottom:1.5pt solid #d33742;padding:0 0 5pt;margin:20pt 0 9pt;break-after:avoid}
.sitrep h3{font-size:12pt;color:#214f70;margin:14pt 0 7pt;break-after:avoid}.sitrep h4{font-size:11pt;margin:10pt 0 5pt;break-after:avoid}
.sitrep p{margin:7pt 0;orphans:3;widows:3}.sitrep small,.sitrep figcaption{display:block;color:#52616d;font-size:8.5pt;line-height:1.4;margin:5pt 0}
...
.sitrep .report-meta{font-size:9pt;color:#52616d}.sitrep .report-summary{background:#fcf0f0;border-left:3pt solid #bb202b;padding:10pt 12pt;margin:12pt 0;break-inside:avoid}
.sitrep .report-summary h2{margin:0;border:0;padding:0;font-size:12pt}.sitrep .report-summary p{margin-bottom:0}
.sitrep .report-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8pt;margin:12pt 0}
.sitrep .report-metrics article{padding:8pt;border:1pt solid #d6e0e6;border-top:2pt solid #214f70;break-inside:avoid}
.sitrep .report-metrics span{display:block;font-size:9pt}.sitrep .report-metrics strong{display:block;font-size:20pt;color:#214f70;margin:3pt 0}
.sitrep table{border-collapse:collapse;width:100%;font-size:9pt;table-layout:fixed;margin:9pt 0;break-inside:avoid}.sitrep caption{text-align:left;color:#52616d;font-size:8.5pt;margin:5pt 0}
.sitrep th,.sitrep td{padding:6pt;text-align:left;vertical-align:top;border-bottom:1pt solid #dce3e9;overflow-wrap:anywhere}
...
.sitrep figure{margin:12pt 0;break-inside:avoid}.sitrep svg{display:block;width:100%;height:auto;max-height:115mm;min-width:0!important;break-inside:avoid}
.sitrep .report-note{padding:8pt 10pt;background:#f3f5f7;font-size:9pt}.sitrep .report-unavailable{color:#52616d;font-style:italic;font-size:10pt}
...
@media print{.sitrep{max-width:none;width:auto;padding:0;margin:0;font-size:10pt;print-color-adjust:exact;-webkit-print-color-adjust:exact}.sitrep .report-metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.sitrep table{font-size:9pt}.sitrep th,.sitrep td{padding:6pt}.sitrep .report-section{break-before:auto}.sitrep h2{margin-top:14pt}.sitrep #sitrep-mining:has(svg),.sitrep #sitrep-security:has(svg){break-before:page}}
